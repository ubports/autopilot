...
use
:meth:`~autopilot.introspection.get_proxy_object_for_already_launched_process`.
...
For instance, to access a long running process that is available before your test starts::
  ...
  app_proxy = get_proxy_object_for_already_launched_process(pid=application_pid)
...
.. note:: Remember that this is only if you can't launch the application from
          within your test, otherwise you would use
